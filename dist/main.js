...
module.exports = __webpack_require__(/*! C:\Users\tthurston\PluralSight\angular-http-communication\src\main.ts */"zUnb");
...
let DataService = class DataService {
    ...
    getBookById(id) {
        let getHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpHeaders"]({
    ...
    getOldBookById(id) {
        ...
        return this.http.get(`api/books/${id}`, {
            headers: getHeaders
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(b => ({
            bookTitle: b.title,
            year: b.publicationYear
        })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(classicBook => console.log(classicBook)));
    }
    addBook(newBook) {
...
const routes = [
    { path: 'dashboard', component: app_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_5__["DashboardComponent"], resolve: { resolvedBooks: _core_books_resolver_service__WEBPACK_IMPORTED_MODULE_8__["BookResolverService"] } },
